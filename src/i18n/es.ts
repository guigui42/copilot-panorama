...
export const es: Translations = {
  ...
  tipsViz: {
    ...
    disabledTools: 'Todos los toolsets habilitados',
    ...
    prefixDiffers: 'el prefijo difiere',
    standard: 'Estándar',
    ...
    summarize: 'Resumir',
    qa: 'P&R',
    refactorLabel: 'Refactorización',
    simpleToMini: 'Simple → mini',
    complexToPremium: 'Complejo → premium',
    icEng: 'Ing. IC',
    powerUser: 'Power user',
    ciAgent: 'Agente de CI',
    stopAfterTest: 'Detenerse tras la primera prueba superada',
    perStep: 'por paso',
    steps: 'pasos',
    accuracy99: '99 %',
    accuracy95: '95 %',
    bePrecise: 'Ser preciso',
    stopSignals: 'Añadir señales de parada',
    knownContext: 'Añadir contexto conocido',
    ...
    multipleCalls: '5 llamadas a herramientas secuenciales',
  ...
  tipsComponents: {
    ...
    'session-limits': {
      ...
      details:
        'Usa `--max-ai-credits` para establecer un límite estricto para las sesiones de Copilot ' +
        'CLI o SDK. Los límites de sesión acotan el trabajo desatendido o de larga duración y ' +
        'complementan los presupuestos, alertas y la aprobación humana. Elige un límite acorde a ' +
        'la tarea y la condición de parada.',
